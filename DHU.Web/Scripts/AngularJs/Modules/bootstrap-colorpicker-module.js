    ...
    .factory('Slider', ['Helper', function (Helper) {
        ...
        return {
            ...
            setSlider: function (event, fixedPosition) {
                ...
                pointer = {
                    left: event.pageX - ((event.offsetX ? event.offsetX : event.originalEvent.layerX) - slider.left),
                    top: event.pageY - ((event.offsetY ? event.offsetY : event.originalEvent.layerY) - slider.top)
                };
            },
        ...
        return {
            ...
            link: function ($scope, elem, attrs, ngModel) {
                var
                    ...
                    withoutButton = angular.isDefined(attrs.withoutbutton) ? attrs.withoutbutton : false,
                    fixedPosition = angular.isDefined(attrs.colorpickerFixedPosition) ? attrs.colorpickerFixedPosition : false,
                    target = angular.isDefined(attrs.colorpickerParent) ? elem.parent() : angular.element(document.body),
                    withInput = angular.isDefined(attrs.colorpickerWithInput) ? attrs.colorpickerWithInput : false,
                    inputTemplate = withInput ? '<input type="text" name="colorpicker-input">' : '',
                    closeButton = !withoutButton ? '<button type="button" class="close close-colorpicker">&times;</button>' : '',
                    template =
